...
/* Step 1: select the title of all the songs by the artist named 'Queen'. */

SELECT title FROM songs WHERE artist = "Queen";


/* Step 2: Select the name of all of the artists from the 'Pop' genre
Tip: Make sure you type it 'Pop', SQL considers that different from 'pop'. */

SELECT name FROM artists WHERE genre = "Pop";


/* Step 3: Add another query that will select the title of all the songs from the 'Pop' artists.
