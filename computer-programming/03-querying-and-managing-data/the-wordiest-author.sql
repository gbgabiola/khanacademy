...
/* Step 1: Select all the authors who have written more than 1 million words, using GROUP BY and HAVING.
...
/* Step 2: Select all the authors that write more than an average of 150,000 words per book.
