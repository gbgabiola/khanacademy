...
/* Step 1: Select all of the rows, and display the name, number_grade, and percent_completed, which you can compute by multiplying and rounding the fraction_completed column. */
...
/* Step 2: The goal is a table that shows how many students have earned which letter_grade.
