...
/* Step 1: Use a JOIN to display a table showing people's names with their hobbies. */
...
/* Step 2: Use another SELECT with a JOIN to show the names of each pair of friends, based on the data in the friends table. */
